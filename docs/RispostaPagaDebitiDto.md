...
**esitoDto** | [**EsitoDto**](EsitoDto.md) |  |  [optional]
**identTransazione** | **String** | Identificativo univoco della transazione creata su PagoPA | 
**url** | **String** | Url che il chiamante dovrà invocare per procedere con il pagamento modello1 dei debiti inviati. Tale url conterrà un token con scadenza | 
