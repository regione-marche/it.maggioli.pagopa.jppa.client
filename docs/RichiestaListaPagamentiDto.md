...
**dataFine** | [**OffsetDateTime**](OffsetDateTime.md) | Data inclusiva, deve essere sempre superiore di almeno 1 giorno alla dataInizio | 
**dataInizio** | [**OffsetDateTime**](OffsetDateTime.md) | Data inclusiva | 
