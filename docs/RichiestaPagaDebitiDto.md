...
------------ | ------------- | ------------- | -------------
**backUrlDto** | [**BackUrlDto**](BackUrlDto.md) |  |  [optional]
...
**debiti** | [**List&lt;DebitoDto&gt;**](DebitoDto.md) |  | 
**debugModeWISP** | **Boolean** | Flag usato in fase di debug |  [optional]
**idRichiestaPagamento** | **String** | Identificativo univoco scelto dal Client chiamante. Identifica l&#39;id carrello e viene agganciato alla transazione | 
**multibeneficiario** | **Boolean** | Flag usato per identificare la nuova modalità con multi beneficiario |  [optional]
**versante** | [**ContribuenteDto**](ContribuenteDto.md) |  | 
