...
------------ | ------------- | ------------- | -------------
**avvisiPagamento** | [**List&lt;NumeroAvvisoCheckoutDto&gt;**](NumeroAvvisoCheckoutDto.md) | Lista dei numeri avviso che si intende pagare. Massimo 5 elementi | 
...
**emailDiNotifica** | **String** | Email alla quale verrà notificato l&#39;esito del pagamento |  [optional]
