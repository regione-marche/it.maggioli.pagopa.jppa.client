...
**dataFine** | [**OffsetDateTime**](OffsetDateTime.md) | Data fine del periodo in cui in cui sono stati creati i debiti scartati |  [optional]
**dataInizio** | [**OffsetDateTime**](OffsetDateTime.md) | Data inizio del periodo in cui in cui sono stati creati i debiti scartati |  [optional]
