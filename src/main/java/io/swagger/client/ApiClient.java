...
//    private String basePath = "https://collaudopagopa.comune-online.it/jcitygov-pagopa/api";
    ...
    public ApiClient() {
        ...
        authentications.put("jwtToken", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://pagopa-staging.maggioli.cloud/jcitygov-pagopa/api/
