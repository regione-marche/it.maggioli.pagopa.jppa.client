...
public class RichiestaAttivaAvvisiPagamentoDto {
  ...
  @SerializedName("numeriAvvisoDto")
  private List<NumeroAvvisoDto> numeriAvvisoDto = null;

  public RichiestaAttivaAvvisiPagamentoDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RichiestaAttivaAvvisiPagamentoDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RichiestaAttivaAvvisiPagamentoDto flagAttiva(Boolean flagAttiva) {
    this.flagAttiva = flagAttiva;
    return this;
  }

   /**
   * Flag di controllo che reindirizza l&#39;attivazione o disattivazione il debito
   * @return flagAttiva
  **/
  @ApiModelProperty(example = "false", value = "Flag di controllo che reindirizza l'attivazione o disattivazione il debito")
  ...
  public RichiestaAttivaAvvisiPagamentoDto numeriAvvisoDto(List<NumeroAvvisoDto> numeriAvvisoDto) {
    this.numeriAvvisoDto = numeriAvvisoDto;
    return this;
  }

  public RichiestaAttivaAvvisiPagamentoDto addNumeriAvvisoDtoItem(NumeroAvvisoDto numeriAvvisoDtoItem) {
    if (this.numeriAvvisoDto == null) {
      this.numeriAvvisoDto = new ArrayList<NumeroAvvisoDto>();
    }
    this.numeriAvvisoDto.add(numeriAvvisoDtoItem);
    return this;
  }

   /**
   * Get numeriAvvisoDto
   * @return numeriAvvisoDto
  **/
  @ApiModelProperty(value = "")
  public List<NumeroAvvisoDto> getNumeriAvvisoDto() {
    return numeriAvvisoDto;
  }

  public void setNumeriAvvisoDto(List<NumeroAvvisoDto> numeriAvvisoDto) {
    this.numeriAvvisoDto = numeriAvvisoDto;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RichiestaAttivaAvvisiPagamentoDto richiestaAttivaAvvisiPagamentoDto = (RichiestaAttivaAvvisiPagamentoDto) o;
    return Objects.equals(this.codIpaRichiedente, richiestaAttivaAvvisiPagamentoDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, richiestaAttivaAvvisiPagamentoDto.codiceServizio) &&
        Objects.equals(this.flagAttiva, richiestaAttivaAvvisiPagamentoDto.flagAttiva) &&
        Objects.equals(this.numeriAvvisoDto, richiestaAttivaAvvisiPagamentoDto.numeriAvvisoDto);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codIpaRichiedente, codiceServizio, flagAttiva, numeriAvvisoDto);
  }
  ...
  public String toString() {
    ...
    sb.append("class RichiestaAttivaAvvisiPagamentoDto {\n");
    ...
    sb.append("    numeriAvvisoDto: ").append(toIndentedString(numeriAvvisoDto)).append("\n");
    sb.append("}");
    return sb.toString();
  }
