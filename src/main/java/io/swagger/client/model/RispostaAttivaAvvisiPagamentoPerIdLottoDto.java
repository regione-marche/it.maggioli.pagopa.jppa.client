...
import io.swagger.client.model.CtAttivaAvvisoPerIdLottoResult;
import java.io.IOException;

/**
 * RispostaAttivaAvvisiPagamentoPerIdLottoDto
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-06-23T07:57:29.055Z")
public class RispostaAttivaAvvisiPagamentoPerIdLottoDto {
  ...
  @SerializedName("numberOfRowsEdited")
  private Integer numberOfRowsEdited = null;

  @SerializedName("result")
  private CtAttivaAvvisoPerIdLottoResult result = null;

  @SerializedName("statoNonAccettato")
  private Boolean statoNonAccettato = null;

  public RispostaAttivaAvvisiPagamentoPerIdLottoDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RispostaAttivaAvvisiPagamentoPerIdLottoDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RispostaAttivaAvvisiPagamentoPerIdLottoDto numberOfRowsEdited(Integer numberOfRowsEdited) {
    this.numberOfRowsEdited = numberOfRowsEdited;
    return this;
  }

   /**
   * Get numberOfRowsEdited
   * @return numberOfRowsEdited
  **/
  @ApiModelProperty(value = "")
  public Integer getNumberOfRowsEdited() {
    return numberOfRowsEdited;
  }

  public void setNumberOfRowsEdited(Integer numberOfRowsEdited) {
    this.numberOfRowsEdited = numberOfRowsEdited;
  }

  public RispostaAttivaAvvisiPagamentoPerIdLottoDto result(CtAttivaAvvisoPerIdLottoResult result) {
    this.result = result;
    return this;
  }
  ...
  **/
  @ApiModelProperty(value = "")
  public CtAttivaAvvisoPerIdLottoResult getResult() {
    return result;
  }

  public void setResult(CtAttivaAvvisoPerIdLottoResult result) {
    this.result = result;
  }

  public RispostaAttivaAvvisiPagamentoPerIdLottoDto statoNonAccettato(Boolean statoNonAccettato) {
    this.statoNonAccettato = statoNonAccettato;
    return this;
  }

   /**
   * Get statoNonAccettato
   * @return statoNonAccettato
  **/
  @ApiModelProperty(value = "")
  public Boolean isStatoNonAccettato() {
    return statoNonAccettato;
  }

  public void setStatoNonAccettato(Boolean statoNonAccettato) {
    this.statoNonAccettato = statoNonAccettato;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RispostaAttivaAvvisiPagamentoPerIdLottoDto rispostaAttivaAvvisiPagamentoPerIdLottoDto = (RispostaAttivaAvvisiPagamentoPerIdLottoDto) o;
    return Objects.equals(this.codIpaRichiedente, rispostaAttivaAvvisiPagamentoPerIdLottoDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, rispostaAttivaAvvisiPagamentoPerIdLottoDto.codiceServizio) &&
        Objects.equals(this.numberOfRowsEdited, rispostaAttivaAvvisiPagamentoPerIdLottoDto.numberOfRowsEdited) &&
        Objects.equals(this.result, rispostaAttivaAvvisiPagamentoPerIdLottoDto.result) &&
        Objects.equals(this.statoNonAccettato, rispostaAttivaAvvisiPagamentoPerIdLottoDto.statoNonAccettato);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codIpaRichiedente, codiceServizio, numberOfRowsEdited, result, statoNonAccettato);
  }
  ...
  public String toString() {
    ...
    sb.append("class RispostaAttivaAvvisiPagamentoPerIdLottoDto {\n");
    ...
    sb.append("    numberOfRowsEdited: ").append(toIndentedString(numberOfRowsEdited)).append("\n");
    sb.append("    result: ").append(toIndentedString(result)).append("\n");
    sb.append("    statoNonAccettato: ").append(toIndentedString(statoNonAccettato)).append("\n");
    sb.append("}");
    return sb.toString();
  }
