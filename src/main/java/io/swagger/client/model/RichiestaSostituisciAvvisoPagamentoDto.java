...
/**
 * RichiestaSostituisciAvvisoPagamentoDto
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-06-23T07:57:29.055Z")
public class RichiestaSostituisciAvvisoPagamentoDto {
  @SerializedName("avvisoPagamentoDto")
  private List<AvvisoPagamentoDto> avvisoPagamentoDto = null;
  ...
  public enum OperazioneEnum {
    ...
    CANCELLAZIONE_DEBITO("CANCELLAZIONE_DEBITO"),
    
    CANCELLAZIONE_SINCRONA_DEBITO("CANCELLAZIONE_SINCRONA_DEBITO"),
    
    CARICAMENTO_DEBITO("CARICAMENTO_DEBITO"),
    
    CARICAMENTO_SINCRONO_DEBITO("CARICAMENTO_SINCRONO_DEBITO"),
    ...
    MODIFICA_SINCRONA_DEBITO("MODIFICA_SINCRONA_DEBITO"),
    
    PAGAMENTO_BOLLO("PAGAMENTO_BOLLO"),
    
    RIATTIVAZIONE_CANCELLATI("RIATTIVAZIONE_CANCELLATI");
  ...
  public RichiestaSostituisciAvvisoPagamentoDto avvisoPagamentoDto(List<AvvisoPagamentoDto> avvisoPagamentoDto) {
    this.avvisoPagamentoDto = avvisoPagamentoDto;
    return this;
  }

  public RichiestaSostituisciAvvisoPagamentoDto addAvvisoPagamentoDtoItem(AvvisoPagamentoDto avvisoPagamentoDtoItem) {
    if (this.avvisoPagamentoDto == null) {
      this.avvisoPagamentoDto = new ArrayList<AvvisoPagamentoDto>();
    }
    this.avvisoPagamentoDto.add(avvisoPagamentoDtoItem);
    return this;
  }

   /**
   * Get avvisoPagamentoDto
   * @return avvisoPagamentoDto
  **/
  @ApiModelProperty(value = "")
  public List<AvvisoPagamentoDto> getAvvisoPagamentoDto() {
    return avvisoPagamentoDto;
  }

  public void setAvvisoPagamentoDto(List<AvvisoPagamentoDto> avvisoPagamentoDto) {
    this.avvisoPagamentoDto = avvisoPagamentoDto;
  }

  public RichiestaSostituisciAvvisoPagamentoDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RichiestaSostituisciAvvisoPagamentoDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RichiestaSostituisciAvvisoPagamentoDto numeroAvvisoDto(NumeroAvvisoDto numeroAvvisoDto) {
  ...
  **/
  ...
  public RichiestaSostituisciAvvisoPagamentoDto operazione(OperazioneEnum operazione) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RichiestaSostituisciAvvisoPagamentoDto richiestaSostituisciAvvisoPagamentoDto = (RichiestaSostituisciAvvisoPagamentoDto) o;
    return Objects.equals(this.avvisoPagamentoDto, richiestaSostituisciAvvisoPagamentoDto.avvisoPagamentoDto) &&
        Objects.equals(this.codIpaRichiedente, richiestaSostituisciAvvisoPagamentoDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, richiestaSostituisciAvvisoPagamentoDto.codiceServizio) &&
        Objects.equals(this.numeroAvvisoDto, richiestaSostituisciAvvisoPagamentoDto.numeroAvvisoDto) &&
        Objects.equals(this.operazione, richiestaSostituisciAvvisoPagamentoDto.operazione);
  }

  @Override
  public int hashCode() {
    return Objects.hash(avvisoPagamentoDto, codIpaRichiedente, codiceServizio, numeroAvvisoDto, operazione);
  }
  ...
  public String toString() {
    ...
    sb.append("class RichiestaSostituisciAvvisoPagamentoDto {\n");
    
    sb.append("    avvisoPagamentoDto: ").append(toIndentedString(avvisoPagamentoDto)).append("\n");
