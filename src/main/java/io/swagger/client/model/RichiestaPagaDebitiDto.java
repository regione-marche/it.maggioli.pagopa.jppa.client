...
public class RichiestaPagaDebitiDto {
  ...
  private List<DebitoDto> debiti = new ArrayList<DebitoDto>();

  @SerializedName("debugModeWISP")
  private Boolean debugModeWISP = null;
  ...
  public RichiestaPagaDebitiDto backUrlDto(BackUrlDto backUrlDto) {
  ...
  **/
  ...
  public RichiestaPagaDebitiDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RichiestaPagaDebitiDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RichiestaPagaDebitiDto debiti(List<DebitoDto> debiti) {
    this.debiti = debiti;
    return this;
  }

  public RichiestaPagaDebitiDto addDebitiItem(DebitoDto debitiItem) {
  ...
  **/
  ...
  public void setDebiti(List<DebitoDto> debiti) {
    this.debiti = debiti;
  }

  public RichiestaPagaDebitiDto debugModeWISP(Boolean debugModeWISP) {
    this.debugModeWISP = debugModeWISP;
    return this;
  }

   /**
   * Flag usato in fase di debug
   * @return debugModeWISP
  **/
  @ApiModelProperty(example = "false", value = "Flag usato in fase di debug")
  public Boolean isDebugModeWISP() {
    return debugModeWISP;
  }

  public void setDebugModeWISP(Boolean debugModeWISP) {
    this.debugModeWISP = debugModeWISP;
  }

  public RichiestaPagaDebitiDto idRichiestaPagamento(String idRichiestaPagamento) {
  ...
  **/
  @ApiModelProperty(example = "13021", required = true, value = "Identificativo univoco scelto dal Client chiamante. Identifica l'id carrello e viene agganciato alla transazione")
  ...
  public RichiestaPagaDebitiDto multibeneficiario(Boolean multibeneficiario) {
    this.multibeneficiario = multibeneficiario;
    return this;
  }

   /**
   * Flag usato per identificare la nuova modalità con multi beneficiario
   * @return multibeneficiario
  **/
  @ApiModelProperty(example = "false", value = "Flag usato per identificare la nuova modalità con multi beneficiario")
  ...
  public RichiestaPagaDebitiDto versante(ContribuenteDto versante) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RichiestaPagaDebitiDto richiestaPagaDebitiDto = (RichiestaPagaDebitiDto) o;
    return Objects.equals(this.backUrlDto, richiestaPagaDebitiDto.backUrlDto) &&
        Objects.equals(this.codIpaRichiedente, richiestaPagaDebitiDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, richiestaPagaDebitiDto.codiceServizio) &&
        Objects.equals(this.debiti, richiestaPagaDebitiDto.debiti) &&
        Objects.equals(this.debugModeWISP, richiestaPagaDebitiDto.debugModeWISP) &&
        Objects.equals(this.idRichiestaPagamento, richiestaPagaDebitiDto.idRichiestaPagamento) &&
        Objects.equals(this.multibeneficiario, richiestaPagaDebitiDto.multibeneficiario) &&
        Objects.equals(this.versante, richiestaPagaDebitiDto.versante);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backUrlDto, codIpaRichiedente, codiceServizio, debiti, debugModeWISP, idRichiestaPagamento, multibeneficiario, versante);
  }
  ...
  public String toString() {
    ...
    sb.append("class RichiestaPagaDebitiDto {\n");
    ...
    sb.append("    debugModeWISP: ").append(toIndentedString(debugModeWISP)).append("\n");
