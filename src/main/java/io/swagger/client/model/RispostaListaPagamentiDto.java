...
public class RispostaListaPagamentiDto {
  ...
  @SerializedName("listaDebiti")
  private List<DebitoPagatoDto> listaDebiti = null;

  public RispostaListaPagamentiDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RispostaListaPagamentiDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RispostaListaPagamentiDto listaDebiti(List<DebitoPagatoDto> listaDebiti) {
    this.listaDebiti = listaDebiti;
    return this;
  }

  public RispostaListaPagamentiDto addListaDebitiItem(DebitoPagatoDto listaDebitiItem) {
    if (this.listaDebiti == null) {
      this.listaDebiti = new ArrayList<DebitoPagatoDto>();
    }
    this.listaDebiti.add(listaDebitiItem);
    return this;
  }
  ...
  **/
  ...
  public List<DebitoPagatoDto> getListaDebiti() {
    return listaDebiti;
  }

  public void setListaDebiti(List<DebitoPagatoDto> listaDebiti) {
    this.listaDebiti = listaDebiti;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RispostaListaPagamentiDto rispostaListaPagamentiDto = (RispostaListaPagamentiDto) o;
    return Objects.equals(this.codIpaRichiedente, rispostaListaPagamentiDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, rispostaListaPagamentiDto.codiceServizio) &&
        Objects.equals(this.listaDebiti, rispostaListaPagamentiDto.listaDebiti);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codIpaRichiedente, codiceServizio, listaDebiti);
  }
  ...
  public String toString() {
    ...
    sb.append("class RispostaListaPagamentiDto {\n");
    ...
    sb.append("    listaDebiti: ").append(toIndentedString(listaDebiti)).append("\n");
    sb.append("}");
    return sb.toString();
  }
