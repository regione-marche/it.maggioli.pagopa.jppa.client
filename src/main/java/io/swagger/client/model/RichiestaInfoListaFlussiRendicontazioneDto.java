...
public class RichiestaInfoListaFlussiRendicontazioneDto {
  ...
  @SerializedName("dataFineRicerca")
  private OffsetDateTime dataFineRicerca = null;

  @SerializedName("dataInizioRicerca")
  private OffsetDateTime dataInizioRicerca = null;

  /**
   * Gets or Sets opzioneFiltroData
   */
  @JsonAdapter(OpzioneFiltroDataEnum.Adapter.class)
  public enum OpzioneFiltroDataEnum {
    INSERIMENTO("DATA_INSERIMENTO"),
    
    REGOLAMENTO("DATA_REGOLAMENTO");

    private String value;

    OpzioneFiltroDataEnum(String value) {
      this.value = value;
    }
    ...
    public static OpzioneFiltroDataEnum fromValue(String text) {
      for (OpzioneFiltroDataEnum b : OpzioneFiltroDataEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<OpzioneFiltroDataEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OpzioneFiltroDataEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public OpzioneFiltroDataEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return OpzioneFiltroDataEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("opzioneFiltroData")
  private OpzioneFiltroDataEnum opzioneFiltroData = null;

  public RichiestaInfoListaFlussiRendicontazioneDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RichiestaInfoListaFlussiRendicontazioneDto codiceIpaBeneficiario(String codiceIpaBeneficiario) {
  ...
  **/
  ...
  public RichiestaInfoListaFlussiRendicontazioneDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RichiestaInfoListaFlussiRendicontazioneDto dataFineRicerca(OffsetDateTime dataFineRicerca) {
    this.dataFineRicerca = dataFineRicerca;
    return this;
  }

   /**
   * Data inclusiva, deve essere sempre superiore di almeno 1 giorno alla dataInizioRicerca
   * @return dataFineRicerca
  **/
  @ApiModelProperty(example = "2023-02-02T00:00:00", required = true, value = "Data inclusiva, deve essere sempre superiore di almeno 1 giorno alla dataInizioRicerca")
  public OffsetDateTime getDataFineRicerca() {
    return dataFineRicerca;
  }

  public void setDataFineRicerca(OffsetDateTime dataFineRicerca) {
    this.dataFineRicerca = dataFineRicerca;
  }

  public RichiestaInfoListaFlussiRendicontazioneDto dataInizioRicerca(OffsetDateTime dataInizioRicerca) {
  ...
  **/
  ...
  public OffsetDateTime getDataInizioRicerca() {
    return dataInizioRicerca;
  }

  public void setDataInizioRicerca(OffsetDateTime dataInizioRicerca) {
    this.dataInizioRicerca = dataInizioRicerca;
  }

  public RichiestaInfoListaFlussiRendicontazioneDto opzioneFiltroData(OpzioneFiltroDataEnum opzioneFiltroData) {
    this.opzioneFiltroData = opzioneFiltroData;
    return this;
  }

   /**
   * Get opzioneFiltroData
   * @return opzioneFiltroData
  **/
  @ApiModelProperty(value = "")
  public OpzioneFiltroDataEnum getOpzioneFiltroData() {
    return opzioneFiltroData;
  }

  public void setOpzioneFiltroData(OpzioneFiltroDataEnum opzioneFiltroData) {
    this.opzioneFiltroData = opzioneFiltroData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RichiestaInfoListaFlussiRendicontazioneDto richiestaInfoListaFlussiRendicontazioneDto = (RichiestaInfoListaFlussiRendicontazioneDto) o;
    return Objects.equals(this.codIpaRichiedente, richiestaInfoListaFlussiRendicontazioneDto.codIpaRichiedente) &&
        Objects.equals(this.codiceIpaBeneficiario, richiestaInfoListaFlussiRendicontazioneDto.codiceIpaBeneficiario) &&
        Objects.equals(this.codiceServizio, richiestaInfoListaFlussiRendicontazioneDto.codiceServizio) &&
        Objects.equals(this.dataFineRicerca, richiestaInfoListaFlussiRendicontazioneDto.dataFineRicerca) &&
        Objects.equals(this.dataInizioRicerca, richiestaInfoListaFlussiRendicontazioneDto.dataInizioRicerca) &&
        Objects.equals(this.opzioneFiltroData, richiestaInfoListaFlussiRendicontazioneDto.opzioneFiltroData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codIpaRichiedente, codiceIpaBeneficiario, codiceServizio, dataFineRicerca, dataInizioRicerca, opzioneFiltroData);
  }
  ...
  public String toString() {
    ...
    sb.append("class RichiestaInfoListaFlussiRendicontazioneDto {\n");
    ...
    sb.append("    dataFineRicerca: ").append(toIndentedString(dataFineRicerca)).append("\n");
    sb.append("    dataInizioRicerca: ").append(toIndentedString(dataInizioRicerca)).append("\n");
    sb.append("    opzioneFiltroData: ").append(toIndentedString(opzioneFiltroData)).append("\n");
    sb.append("}");
    return sb.toString();
  }
