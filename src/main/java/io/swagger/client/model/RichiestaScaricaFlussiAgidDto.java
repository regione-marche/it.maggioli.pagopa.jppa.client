...
public class RichiestaScaricaFlussiAgidDto {
  ...
  @SerializedName("dataDiInserimento")
  private DateInterval dataDiInserimento = null;

  @SerializedName("dataDiPresentazione")
  private DateInterval dataDiPresentazione = null;

  @SerializedName("dataDiRegolamento")
  private DateInterval dataDiRegolamento = null;

  @SerializedName("identFlusso")
  private String identFlusso = null;

  public RichiestaScaricaFlussiAgidDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RichiestaScaricaFlussiAgidDto codiceIpa(String codiceIpa) {
  ...
  **/
  ...
  public RichiestaScaricaFlussiAgidDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RichiestaScaricaFlussiAgidDto dataDiInserimento(DateInterval dataDiInserimento) {
    this.dataDiInserimento = dataDiInserimento;
    return this;
  }

   /**
   * Get dataDiInserimento
   * @return dataDiInserimento
  **/
  @ApiModelProperty(value = "")
  public DateInterval getDataDiInserimento() {
    return dataDiInserimento;
  }

  public void setDataDiInserimento(DateInterval dataDiInserimento) {
    this.dataDiInserimento = dataDiInserimento;
  }

  public RichiestaScaricaFlussiAgidDto dataDiPresentazione(DateInterval dataDiPresentazione) {
    this.dataDiPresentazione = dataDiPresentazione;
    return this;
  }

   /**
   * Get dataDiPresentazione
   * @return dataDiPresentazione
  **/
  @ApiModelProperty(value = "")
  public DateInterval getDataDiPresentazione() {
    return dataDiPresentazione;
  }

  public void setDataDiPresentazione(DateInterval dataDiPresentazione) {
    this.dataDiPresentazione = dataDiPresentazione;
  }

  public RichiestaScaricaFlussiAgidDto dataDiRegolamento(DateInterval dataDiRegolamento) {
    this.dataDiRegolamento = dataDiRegolamento;
    return this;
  }

   /**
   * Get dataDiRegolamento
   * @return dataDiRegolamento
  **/
  @ApiModelProperty(value = "")
  public DateInterval getDataDiRegolamento() {
    return dataDiRegolamento;
  }

  public void setDataDiRegolamento(DateInterval dataDiRegolamento) {
    this.dataDiRegolamento = dataDiRegolamento;
  }

  public RichiestaScaricaFlussiAgidDto identFlusso(String identFlusso) {
    this.identFlusso = identFlusso;
    return this;
  }
   ...
   * @return identFlusso
  **/
  @ApiModelProperty(example = "2022-01-26BPPNIT2PXXX-S", value = "")
  public String getIdentFlusso() {
    return identFlusso;
  }

  public void setIdentFlusso(String identFlusso) {
    this.identFlusso = identFlusso;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RichiestaScaricaFlussiAgidDto richiestaScaricaFlussiAgidDto = (RichiestaScaricaFlussiAgidDto) o;
    return Objects.equals(this.codIpaRichiedente, richiestaScaricaFlussiAgidDto.codIpaRichiedente) &&
        Objects.equals(this.codiceIpa, richiestaScaricaFlussiAgidDto.codiceIpa) &&
        Objects.equals(this.codiceServizio, richiestaScaricaFlussiAgidDto.codiceServizio) &&
        Objects.equals(this.dataDiInserimento, richiestaScaricaFlussiAgidDto.dataDiInserimento) &&
        Objects.equals(this.dataDiPresentazione, richiestaScaricaFlussiAgidDto.dataDiPresentazione) &&
        Objects.equals(this.dataDiRegolamento, richiestaScaricaFlussiAgidDto.dataDiRegolamento) &&
        Objects.equals(this.identFlusso, richiestaScaricaFlussiAgidDto.identFlusso);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codIpaRichiedente, codiceIpa, codiceServizio, dataDiInserimento, dataDiPresentazione, dataDiRegolamento, identFlusso);
  }
  ...
  public String toString() {
    ...
    sb.append("class RichiestaScaricaFlussiAgidDto {\n");
    ...
    sb.append("    dataDiInserimento: ").append(toIndentedString(dataDiInserimento)).append("\n");
    sb.append("    dataDiPresentazione: ").append(toIndentedString(dataDiPresentazione)).append("\n");
    sb.append("    dataDiRegolamento: ").append(toIndentedString(dataDiRegolamento)).append("\n");
    sb.append("    identFlusso: ").append(toIndentedString(identFlusso)).append("\n");
    sb.append("}");
    return sb.toString();
  }
