...
import io.swagger.client.model.AttivaAvvisoPagamentoResultDto;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

/**
 * RispostaAttivaAvvisiPagamentoDto
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-06-23T07:57:29.055Z")
public class RispostaAttivaAvvisiPagamentoDto {
  @SerializedName("attivaAvvisiResultDto")
  private List<AttivaAvvisoPagamentoResultDto> attivaAvvisiResultDto = null;
  ...
  public RispostaAttivaAvvisiPagamentoDto attivaAvvisiResultDto(List<AttivaAvvisoPagamentoResultDto> attivaAvvisiResultDto) {
    this.attivaAvvisiResultDto = attivaAvvisiResultDto;
    return this;
  }

  public RispostaAttivaAvvisiPagamentoDto addAttivaAvvisiResultDtoItem(AttivaAvvisoPagamentoResultDto attivaAvvisiResultDtoItem) {
    if (this.attivaAvvisiResultDto == null) {
      this.attivaAvvisiResultDto = new ArrayList<AttivaAvvisoPagamentoResultDto>();
    }
    this.attivaAvvisiResultDto.add(attivaAvvisiResultDtoItem);
    return this;
  }

   /**
   * Get attivaAvvisiResultDto
   * @return attivaAvvisiResultDto
  **/
  @ApiModelProperty(value = "")
  public List<AttivaAvvisoPagamentoResultDto> getAttivaAvvisiResultDto() {
    return attivaAvvisiResultDto;
  }

  public void setAttivaAvvisiResultDto(List<AttivaAvvisoPagamentoResultDto> attivaAvvisiResultDto) {
    this.attivaAvvisiResultDto = attivaAvvisiResultDto;
  }

  public RispostaAttivaAvvisiPagamentoDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RispostaAttivaAvvisiPagamentoDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RispostaAttivaAvvisiPagamentoDto rispostaAttivaAvvisiPagamentoDto = (RispostaAttivaAvvisiPagamentoDto) o;
    return Objects.equals(this.attivaAvvisiResultDto, rispostaAttivaAvvisiPagamentoDto.attivaAvvisiResultDto) &&
        Objects.equals(this.codIpaRichiedente, rispostaAttivaAvvisiPagamentoDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, rispostaAttivaAvvisiPagamentoDto.codiceServizio);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attivaAvvisiResultDto, codIpaRichiedente, codiceServizio);
  }
  ...
  public String toString() {
    ...
    sb.append("class RispostaAttivaAvvisiPagamentoDto {\n");
    
    sb.append("    attivaAvvisiResultDto: ").append(toIndentedString(attivaAvvisiResultDto)).append("\n");
