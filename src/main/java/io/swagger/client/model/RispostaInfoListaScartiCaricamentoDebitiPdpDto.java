...
import io.swagger.client.model.ListaScartiCaricamentoDebitiPdp;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

/**
 * RispostaInfoListaScartiCaricamentoDebitiPdpDto
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-06-23T07:57:29.055Z")
public class RispostaInfoListaScartiCaricamentoDebitiPdpDto {
  ...
  @SerializedName("listaScartiCaricamentoDebitiPdp")
  private List<ListaScartiCaricamentoDebitiPdp> listaScartiCaricamentoDebitiPdp = null;

  public RispostaInfoListaScartiCaricamentoDebitiPdpDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RispostaInfoListaScartiCaricamentoDebitiPdpDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RispostaInfoListaScartiCaricamentoDebitiPdpDto listaScartiCaricamentoDebitiPdp(List<ListaScartiCaricamentoDebitiPdp> listaScartiCaricamentoDebitiPdp) {
    this.listaScartiCaricamentoDebitiPdp = listaScartiCaricamentoDebitiPdp;
    return this;
  }

  public RispostaInfoListaScartiCaricamentoDebitiPdpDto addListaScartiCaricamentoDebitiPdpItem(ListaScartiCaricamentoDebitiPdp listaScartiCaricamentoDebitiPdpItem) {
    if (this.listaScartiCaricamentoDebitiPdp == null) {
      this.listaScartiCaricamentoDebitiPdp = new ArrayList<ListaScartiCaricamentoDebitiPdp>();
    }
    this.listaScartiCaricamentoDebitiPdp.add(listaScartiCaricamentoDebitiPdpItem);
    return this;
  }

   /**
   * Get listaScartiCaricamentoDebitiPdp
   * @return listaScartiCaricamentoDebitiPdp
  **/
  @ApiModelProperty(value = "")
  public List<ListaScartiCaricamentoDebitiPdp> getListaScartiCaricamentoDebitiPdp() {
    return listaScartiCaricamentoDebitiPdp;
  }

  public void setListaScartiCaricamentoDebitiPdp(List<ListaScartiCaricamentoDebitiPdp> listaScartiCaricamentoDebitiPdp) {
    this.listaScartiCaricamentoDebitiPdp = listaScartiCaricamentoDebitiPdp;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RispostaInfoListaScartiCaricamentoDebitiPdpDto rispostaInfoListaScartiCaricamentoDebitiPdpDto = (RispostaInfoListaScartiCaricamentoDebitiPdpDto) o;
    return Objects.equals(this.codIpaRichiedente, rispostaInfoListaScartiCaricamentoDebitiPdpDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, rispostaInfoListaScartiCaricamentoDebitiPdpDto.codiceServizio) &&
        Objects.equals(this.listaScartiCaricamentoDebitiPdp, rispostaInfoListaScartiCaricamentoDebitiPdpDto.listaScartiCaricamentoDebitiPdp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codIpaRichiedente, codiceServizio, listaScartiCaricamentoDebitiPdp);
  }
  ...
  public String toString() {
    ...
    sb.append("class RispostaInfoListaScartiCaricamentoDebitiPdpDto {\n");
    ...
    sb.append("    listaScartiCaricamentoDebitiPdp: ").append(toIndentedString(listaScartiCaricamentoDebitiPdp)).append("\n");
    sb.append("}");
    return sb.toString();
  }
