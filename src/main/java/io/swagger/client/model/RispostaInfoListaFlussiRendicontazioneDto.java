...
public class RispostaInfoListaFlussiRendicontazioneDto {
  ...
  @SerializedName("listaFlussiRendicontazione")
  private List<String> listaFlussiRendicontazione = null;

  public RispostaInfoListaFlussiRendicontazioneDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RispostaInfoListaFlussiRendicontazioneDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RispostaInfoListaFlussiRendicontazioneDto listaFlussiRendicontazione(List<String> listaFlussiRendicontazione) {
    this.listaFlussiRendicontazione = listaFlussiRendicontazione;
    return this;
  }

  public RispostaInfoListaFlussiRendicontazioneDto addListaFlussiRendicontazioneItem(String listaFlussiRendicontazioneItem) {
    if (this.listaFlussiRendicontazione == null) {
      this.listaFlussiRendicontazione = new ArrayList<String>();
    }
    this.listaFlussiRendicontazione.add(listaFlussiRendicontazioneItem);
    return this;
  }

   /**
   * Get listaFlussiRendicontazione
   * @return listaFlussiRendicontazione
  **/
  @ApiModelProperty(value = "")
  public List<String> getListaFlussiRendicontazione() {
    return listaFlussiRendicontazione;
  }

  public void setListaFlussiRendicontazione(List<String> listaFlussiRendicontazione) {
    this.listaFlussiRendicontazione = listaFlussiRendicontazione;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RispostaInfoListaFlussiRendicontazioneDto rispostaInfoListaFlussiRendicontazioneDto = (RispostaInfoListaFlussiRendicontazioneDto) o;
    return Objects.equals(this.codIpaRichiedente, rispostaInfoListaFlussiRendicontazioneDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, rispostaInfoListaFlussiRendicontazioneDto.codiceServizio) &&
        Objects.equals(this.listaFlussiRendicontazione, rispostaInfoListaFlussiRendicontazioneDto.listaFlussiRendicontazione);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codIpaRichiedente, codiceServizio, listaFlussiRendicontazione);
  }
  ...
  public String toString() {
    ...
    sb.append("class RispostaInfoListaFlussiRendicontazioneDto {\n");
    ...
    sb.append("    listaFlussiRendicontazione: ").append(toIndentedString(listaFlussiRendicontazione)).append("\n");
    sb.append("}");
    return sb.toString();
  }
