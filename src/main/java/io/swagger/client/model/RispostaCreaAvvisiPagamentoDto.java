...
import io.swagger.client.model.AvvisoPagamentoResultDto;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

/**
 * RispostaCreaAvvisiPagamentoDto
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-06-23T07:57:29.055Z")
public class RispostaCreaAvvisiPagamentoDto {
  @SerializedName("avvisiPagamentoResultDto")
  private List<AvvisoPagamentoResultDto> avvisiPagamentoResultDto = null;
  ...
  public RispostaCreaAvvisiPagamentoDto avvisiPagamentoResultDto(List<AvvisoPagamentoResultDto> avvisiPagamentoResultDto) {
    this.avvisiPagamentoResultDto = avvisiPagamentoResultDto;
    return this;
  }

  public RispostaCreaAvvisiPagamentoDto addAvvisiPagamentoResultDtoItem(AvvisoPagamentoResultDto avvisiPagamentoResultDtoItem) {
    if (this.avvisiPagamentoResultDto == null) {
      this.avvisiPagamentoResultDto = new ArrayList<AvvisoPagamentoResultDto>();
    }
    this.avvisiPagamentoResultDto.add(avvisiPagamentoResultDtoItem);
    return this;
  }

   /**
   * Get avvisiPagamentoResultDto
   * @return avvisiPagamentoResultDto
  **/
  @ApiModelProperty(value = "")
  public List<AvvisoPagamentoResultDto> getAvvisiPagamentoResultDto() {
    return avvisiPagamentoResultDto;
  }

  public void setAvvisiPagamentoResultDto(List<AvvisoPagamentoResultDto> avvisiPagamentoResultDto) {
    this.avvisiPagamentoResultDto = avvisiPagamentoResultDto;
  }

  public RispostaCreaAvvisiPagamentoDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RispostaCreaAvvisiPagamentoDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RispostaCreaAvvisiPagamentoDto rispostaCreaAvvisiPagamentoDto = (RispostaCreaAvvisiPagamentoDto) o;
    return Objects.equals(this.avvisiPagamentoResultDto, rispostaCreaAvvisiPagamentoDto.avvisiPagamentoResultDto) &&
        Objects.equals(this.codIpaRichiedente, rispostaCreaAvvisiPagamentoDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, rispostaCreaAvvisiPagamentoDto.codiceServizio);
  }

  @Override
  public int hashCode() {
    return Objects.hash(avvisiPagamentoResultDto, codIpaRichiedente, codiceServizio);
  }
  ...
  public String toString() {
    ...
    sb.append("class RispostaCreaAvvisiPagamentoDto {\n");
    
    sb.append("    avvisiPagamentoResultDto: ").append(toIndentedString(avvisiPagamentoResultDto)).append("\n");
