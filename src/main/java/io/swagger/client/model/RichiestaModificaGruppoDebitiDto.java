...
import io.swagger.client.model.ModificaGruppoDebitiDto;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

/**
 * RichiestaModificaGruppoDebitiDto
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-06-23T07:57:29.055Z")
public class RichiestaModificaGruppoDebitiDto {
  ...
  @SerializedName("listaModificaGruppoDebitiDto")
  private List<ModificaGruppoDebitiDto> listaModificaGruppoDebitiDto = null;

  public RichiestaModificaGruppoDebitiDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RichiestaModificaGruppoDebitiDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RichiestaModificaGruppoDebitiDto listaModificaGruppoDebitiDto(List<ModificaGruppoDebitiDto> listaModificaGruppoDebitiDto) {
    this.listaModificaGruppoDebitiDto = listaModificaGruppoDebitiDto;
    return this;
  }

  public RichiestaModificaGruppoDebitiDto addListaModificaGruppoDebitiDtoItem(ModificaGruppoDebitiDto listaModificaGruppoDebitiDtoItem) {
    if (this.listaModificaGruppoDebitiDto == null) {
      this.listaModificaGruppoDebitiDto = new ArrayList<ModificaGruppoDebitiDto>();
    }
    this.listaModificaGruppoDebitiDto.add(listaModificaGruppoDebitiDtoItem);
    return this;
  }

   /**
   * Get listaModificaGruppoDebitiDto
   * @return listaModificaGruppoDebitiDto
  **/
  @ApiModelProperty(value = "")
  public List<ModificaGruppoDebitiDto> getListaModificaGruppoDebitiDto() {
    return listaModificaGruppoDebitiDto;
  }

  public void setListaModificaGruppoDebitiDto(List<ModificaGruppoDebitiDto> listaModificaGruppoDebitiDto) {
    this.listaModificaGruppoDebitiDto = listaModificaGruppoDebitiDto;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RichiestaModificaGruppoDebitiDto richiestaModificaGruppoDebitiDto = (RichiestaModificaGruppoDebitiDto) o;
    return Objects.equals(this.codIpaRichiedente, richiestaModificaGruppoDebitiDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, richiestaModificaGruppoDebitiDto.codiceServizio) &&
        Objects.equals(this.listaModificaGruppoDebitiDto, richiestaModificaGruppoDebitiDto.listaModificaGruppoDebitiDto);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codIpaRichiedente, codiceServizio, listaModificaGruppoDebitiDto);
  }
  ...
  public String toString() {
    ...
    sb.append("class RichiestaModificaGruppoDebitiDto {\n");
    ...
    sb.append("    listaModificaGruppoDebitiDto: ").append(toIndentedString(listaModificaGruppoDebitiDto)).append("\n");
    sb.append("}");
    return sb.toString();
  }
