...
/**
 * RichiestaCreaAvvisiPagamentoDto
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-06-23T07:57:29.055Z")
public class RichiestaCreaAvvisiPagamentoDto {
  @SerializedName("avvisiDiPagamento")
  private List<AvvisoPagamentoDto> avvisiDiPagamento = null;
  ...
  @SerializedName("notificaNumeroAvviso")
  private Boolean notificaNumeroAvviso = null;

  @SerializedName("transactional")
  private Boolean transactional = null;

  public RichiestaCreaAvvisiPagamentoDto avvisiDiPagamento(List<AvvisoPagamentoDto> avvisiDiPagamento) {
    this.avvisiDiPagamento = avvisiDiPagamento;
    return this;
  }

  public RichiestaCreaAvvisiPagamentoDto addAvvisiDiPagamentoItem(AvvisoPagamentoDto avvisiDiPagamentoItem) {
    if (this.avvisiDiPagamento == null) {
      this.avvisiDiPagamento = new ArrayList<AvvisoPagamentoDto>();
    }
    this.avvisiDiPagamento.add(avvisiDiPagamentoItem);
    return this;
  }

   /**
   * Get avvisiDiPagamento
   * @return avvisiDiPagamento
  **/
  @ApiModelProperty(value = "")
  public List<AvvisoPagamentoDto> getAvvisiDiPagamento() {
    return avvisiDiPagamento;
  }

  public void setAvvisiDiPagamento(List<AvvisoPagamentoDto> avvisiDiPagamento) {
    this.avvisiDiPagamento = avvisiDiPagamento;
  }

  public RichiestaCreaAvvisiPagamentoDto codIpaRichiedente(String codIpaRichiedente) {
  ...
  **/
  ...
  public RichiestaCreaAvvisiPagamentoDto codiceServizio(CodiceServizioEnum codiceServizio) {
  ...
  **/
  ...
  public RichiestaCreaAvvisiPagamentoDto notificaNumeroAvviso(Boolean notificaNumeroAvviso) {
    this.notificaNumeroAvviso = notificaNumeroAvviso;
    return this;
  }

   /**
   * Get notificaNumeroAvviso
   * @return notificaNumeroAvviso
  **/
  @ApiModelProperty(value = "")
  public Boolean isNotificaNumeroAvviso() {
    return notificaNumeroAvviso;
  }

  public void setNotificaNumeroAvviso(Boolean notificaNumeroAvviso) {
    this.notificaNumeroAvviso = notificaNumeroAvviso;
  }

  public RichiestaCreaAvvisiPagamentoDto transactional(Boolean transactional) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RichiestaCreaAvvisiPagamentoDto richiestaCreaAvvisiPagamentoDto = (RichiestaCreaAvvisiPagamentoDto) o;
    return Objects.equals(this.avvisiDiPagamento, richiestaCreaAvvisiPagamentoDto.avvisiDiPagamento) &&
        Objects.equals(this.codIpaRichiedente, richiestaCreaAvvisiPagamentoDto.codIpaRichiedente) &&
        Objects.equals(this.codiceServizio, richiestaCreaAvvisiPagamentoDto.codiceServizio) &&
        Objects.equals(this.notificaNumeroAvviso, richiestaCreaAvvisiPagamentoDto.notificaNumeroAvviso) &&
        Objects.equals(this.transactional, richiestaCreaAvvisiPagamentoDto.transactional);
  }

  @Override
  public int hashCode() {
    return Objects.hash(avvisiDiPagamento, codIpaRichiedente, codiceServizio, notificaNumeroAvviso, transactional);
  }
  ...
  public String toString() {
    ...
    sb.append("class RichiestaCreaAvvisiPagamentoDto {\n");
    
    sb.append("    avvisiDiPagamento: ").append(toIndentedString(avvisiDiPagamento)).append("\n");
    ...
    sb.append("    notificaNumeroAvviso: ").append(toIndentedString(notificaNumeroAvviso)).append("\n");
